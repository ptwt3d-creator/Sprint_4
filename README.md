...
- `test_add_book_in_favorites_add_book` - Изолированная проверка добавления книги в избранное.
...
- `collector_book` - Автоматическое создание чистого объекта BooksCollector перед каждым тестом.

- `favorite_book` - Фикстура подготовки данных, Автоматически создает и добавляет книгу в избранное, возвращает название книги.